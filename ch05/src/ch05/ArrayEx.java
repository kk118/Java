...
public class ArrayEx {
	public void arrayEx1() {
		...
		int intArr4[] = new int[5]; // 배열 크기를 5로 고정하고 데이터는 미입력.
		...
		intArr3[4] = 500;
		System.out.println("배열 intArr3의 index 4번값 : " + intArr3[4]);
...
//		문제 3) 배열(크기 5)을 사용하여 점수의 총합과 평균을 구하는 프로그램을 작성하세요. 
//		사용자 점수 입력은 원할 경우 구현
		System.out.println("\n---arrayEx3---\n");
		...
		System.out.println("평균점은 : " + avg + "입니다.");
